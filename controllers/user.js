...
async function getUserDataWithToken(req, res) {
  ...
  // Example function to verify and decode the token (you should implement this)
  function verifyAndDecodeToken(token) {
    // Your implementation to verify and decode the token
    // This depends on the library or method you are using for authentication
    // Return the decoded token or null if the verification fails
  }
